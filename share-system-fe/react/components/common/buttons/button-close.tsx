    ...
    return (
        ...
        <button
            ...
            className={classNames(
                ...
                {
                    'btn-secondary':
                        variant === 'contained' && !buttonClassType,
                    'btn-link btn-color-secondary ':
                        variant === 'text' && !buttonClassType,
                    'btn-outline btn-outline-dark ':
                        variant === 'outlined' && !buttonClassType,
                    'btn-outline btn-outline-dashed btn-outline-dark ':
                        variant === 'dashed' && !buttonClassType,
                    'btn-icon': buttonIcon,
                },
                className,
                buttonClassType
