...
var BryntumResourceCombo = /*#__PURE__*/function (_Component) {
  _inherits(BryntumResourceCombo, _Component);

  var _super = _createSuper(BryntumResourceCombo);

  function BryntumResourceCombo() {
    var _this;

    _classCallCheck(this, BryntumResourceCombo);
  ...
  _createClass(BryntumResourceCombo, [{
  ...
  return BryntumResourceCombo;
}(Component);

BryntumResourceCombo.instanceClass = ResourceCombo;
export { BryntumResourceCombo as default };