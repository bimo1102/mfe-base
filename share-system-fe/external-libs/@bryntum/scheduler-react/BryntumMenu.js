...
var BryntumMenu = /*#__PURE__*/function (_Component) {
  _inherits(BryntumMenu, _Component);

  var _super = _createSuper(BryntumMenu);

  function BryntumMenu() {
    var _this;

    _classCallCheck(this, BryntumMenu);
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'autoClose', 'autoShow', 'bbar', 'bodyCls', 'bubbleEvents', 'centered', 'closable', 'closeAction', 'cls', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'defaults', 'dock', 'draggable', 'floating', 'focusOnHover', 'focusOnToFront', 'footer', 'forElement', 'header', 'hideAnimation', 'hideWhenEmpty', 'htmlCls', 'insertBefore', 'insertFirst', 'itemCls', 'lazyItems', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'maximizable', 'modal', 'monitorResize', 'namedItems', 'owner', 'positioned', 'preventTooltipOnTouch', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showOnClick', 'showTooltipWhenDisabled', 'strips', 'tab', 'tag', 'tbar', 'textAlign', 'textContent', 'title', 'trapFocus', 'weight'];
    _this.propertyConfigNames = ['alignSelf', 'content', 'dataset', 'disabled', 'extraData', 'flex', 'height', 'hidden', 'html', 'id', 'items', 'layout', 'layoutStyle', 'margin', 'maxHeight', 'maximized', 'maxWidth', 'minHeight', 'minWidth', 'onBeforeClose', 'onBeforeDestroy', 'onBeforeHide', 'onBeforeSetRecord', 'onBeforeShow', 'onCatchAll', 'onDestroy', 'onFocusIn', 'onFocusOut', 'onHide', 'onItem', 'onPaint', 'onReadOnly', 'onResize', 'onShow', 'onToggle', 'onToolClick', 'readOnly', 'scrollable', 'tools', 'tooltip', 'width', 'x', 'y'];
    _this.propertyNames = ['anchorSize', 'isSettingValues', 'isValid', 'parentMenu', 'record', 'selectedElement', 'values'];
    _this.instance = undefined;
    _this.element = undefined;
    return _this;
  }

  _createClass(BryntumMenu, [{
