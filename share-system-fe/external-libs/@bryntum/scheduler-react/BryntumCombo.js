...
var BryntumCombo = /*#__PURE__*/function (_Component) {
  _inherits(BryntumCombo, _Component);

  var _super = _createSuper(BryntumCombo);

  function BryntumCombo() {
    var _this;

    _classCallCheck(this, BryntumCombo);
...
export { BryntumCombo as default };