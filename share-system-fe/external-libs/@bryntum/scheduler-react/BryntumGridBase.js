...
import { GridBase } from '@bryntum/scheduler/scheduler.umd';

var BryntumGridBase = /*#__PURE__*/function (_Component) {
  _inherits(BryntumGridBase, _Component);

  var _super = _createSuper(BryntumGridBase);

  function BryntumGridBase() {
    var _this;

    _classCallCheck(this, BryntumGridBase);
