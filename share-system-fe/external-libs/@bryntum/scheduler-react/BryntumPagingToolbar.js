...
import { PagingToolbar } from '@bryntum/scheduler/scheduler.umd';

var BryntumPagingToolbar = /*#__PURE__*/function (_Component) {
  _inherits(BryntumPagingToolbar, _Component);

  var _super = _createSuper(BryntumPagingToolbar);

  function BryntumPagingToolbar() {
    var _this;

    _classCallCheck(this, BryntumPagingToolbar);
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'bubbleEvents', 'centered', 'cls', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'defaults', 'dock', 'draggable', 'floating', 'hideAnimation', 'hideWhenEmpty', 'htmlCls', 'insertBefore', 'insertFirst', 'itemCls', 'lazyItems', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'monitorResize', 'namedItems', 'overflow', 'owner', 'positioned', 'preventTooltipOnTouch', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'store', 'tab', 'tag', 'textAlign', 'textContent', 'title', 'tools', 'weight', 'widgetCls'];
  ...
  _createClass(BryntumPagingToolbar, [{
  ...
  return BryntumPagingToolbar;
}(Component);

BryntumPagingToolbar.instanceClass = PagingToolbar;
export { BryntumPagingToolbar as default };