...
import { FilterField } from '@bryntum/scheduler/scheduler.umd';

var BryntumFilterField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumFilterField, _Component);

  var _super = _createSuper(BryntumFilterField);

  function BryntumFilterField() {
    var _this;

    _classCallCheck(this, BryntumFilterField);
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'autoComplete', 'autoSelect', 'bubbleEvents', 'centered', 'clearable', 'cls', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'dock', 'draggable', 'editable', 'field', 'filterFunction', 'floating', 'hideAnimation', 'highlightExternalChange', 'hint', 'hintHtml', 'htmlCls', 'inputAlign', 'inputAttributes', 'inputWidth', 'insertBefore', 'insertFirst', 'keyStrokeChangeDelay', 'labelCls', 'labelPosition', 'labels', 'labelWidth', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'maxLength', 'minLength', 'monitorResize', 'name', 'owner', 'placeholder', 'positioned', 'preventTooltipOnTouch', 'required', 'revertOnEscape', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'store', 'tab', 'tabIndex', 'tag', 'textAlign', 'title', 'weight'];
  ...
  _createClass(BryntumFilterField, [{
  ...
  return BryntumFilterField;
}(Component);

BryntumFilterField.instanceClass = FilterField;
export { BryntumFilterField as default };