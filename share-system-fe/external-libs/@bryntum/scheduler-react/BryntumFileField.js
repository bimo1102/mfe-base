...
import { FileField } from '@bryntum/scheduler/scheduler.umd';

var BryntumFileField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumFileField, _Component);

  var _super = _createSuper(BryntumFileField);

  function BryntumFileField() {
    var _this;

    _classCallCheck(this, BryntumFileField);
    ...
    _this.configNames = ['accept', 'adopt', 'align', 'anchor', 'appendTo', 'autoComplete', 'autoSelect', 'bubbleEvents', 'centered', 'clearable', 'cls', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'dock', 'draggable', 'editable', 'floating', 'hideAnimation', 'highlightExternalChange', 'hint', 'hintHtml', 'htmlCls', 'inputAlign', 'inputAttributes', 'inputWidth', 'insertBefore', 'insertFirst', 'keyStrokeChangeDelay', 'labelCls', 'labelPosition', 'labels', 'labelWidth', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'monitorResize', 'multiple', 'name', 'owner', 'placeholder', 'positioned', 'preventTooltipOnTouch', 'required', 'revertOnEscape', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'tab', 'tag', 'textAlign', 'title', 'weight'];
  ...
  return BryntumFileField;
}(Component);

BryntumFileField.instanceClass = FileField;
export { BryntumFileField as default };