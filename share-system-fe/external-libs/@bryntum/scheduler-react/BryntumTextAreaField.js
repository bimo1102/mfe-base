...
var BryntumTextAreaField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumTextAreaField, _Component);

  var _super = _createSuper(BryntumTextAreaField);

  function BryntumTextAreaField() {
    var _this;

    _classCallCheck(this, BryntumTextAreaField);
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'autoComplete', 'autoSelect', 'bubbleEvents', 'centered', 'clearable', 'cls', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'dock', 'draggable', 'editable', 'floating', 'hideAnimation', 'highlightExternalChange', 'hint', 'hintHtml', 'htmlCls', 'inline', 'inputAlign', 'inputAttributes', 'inputWidth', 'insertBefore', 'insertFirst', 'keyStrokeChangeDelay', 'labelCls', 'labelPosition', 'labels', 'labelWidth', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'monitorResize', 'name', 'owner', 'placeholder', 'positioned', 'preventTooltipOnTouch', 'required', 'resize', 'revertOnEscape', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'tab', 'tag', 'textAlign', 'title', 'weight'];
  ...
  _createClass(BryntumTextAreaField, [{
  ...
  return BryntumTextAreaField;
}(Component);

BryntumTextAreaField.instanceClass = TextAreaField;
export { BryntumTextAreaField as default };