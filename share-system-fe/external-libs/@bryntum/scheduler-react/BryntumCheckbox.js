...
import { Checkbox } from '@bryntum/scheduler/scheduler.umd';

var BryntumCheckbox = /*#__PURE__*/function (_Component) {
  _inherits(BryntumCheckbox, _Component);

  var _super = _createSuper(BryntumCheckbox);

  function BryntumCheckbox() {
    var _this;

    _classCallCheck(this, BryntumCheckbox);
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'autoComplete', 'autoSelect', 'bubbleEvents', 'centered', 'clearable', 'cls', 'color', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'dock', 'draggable', 'editable', 'floating', 'hideAnimation', 'highlightExternalChange', 'hint', 'hintHtml', 'htmlCls', 'inputAlign', 'inputAttributes', 'inputWidth', 'insertBefore', 'insertFirst', 'keyStrokeChangeDelay', 'labelCls', 'labelPosition', 'labels', 'labelWidth', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'monitorResize', 'owner', 'placeholder', 'positioned', 'preventTooltipOnTouch', 'required', 'revertOnEscape', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'tab', 'tag', 'text', 'textAlign', 'title', 'weight'];
  ...
  return BryntumCheckbox;
}(Component);

BryntumCheckbox.instanceClass = Checkbox;
export { BryntumCheckbox as default };