...
import { TextField } from '@bryntum/scheduler/scheduler.umd';

var BryntumTextField = /*#__PURE__*/function (_Component) {
  _inherits(BryntumTextField, _Component);

  var _super = _createSuper(BryntumTextField);

  function BryntumTextField() {
    var _this;

    _classCallCheck(this, BryntumTextField);
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'autoComplete', 'autoSelect', 'bubbleEvents', 'centered', 'clearable', 'cls', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'dock', 'draggable', 'editable', 'floating', 'hideAnimation', 'highlightExternalChange', 'hint', 'hintHtml', 'htmlCls', 'inputAlign', 'inputAttributes', 'inputWidth', 'insertBefore', 'insertFirst', 'keyStrokeChangeDelay', 'labelCls', 'labelPosition', 'labels', 'labelWidth', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'maxLength', 'minLength', 'monitorResize', 'name', 'owner', 'placeholder', 'positioned', 'preventTooltipOnTouch', 'required', 'revertOnEscape', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'tab', 'tabIndex', 'tag', 'textAlign', 'title', 'weight'];
  ...
  return BryntumTextField;
}(Component);

BryntumTextField.instanceClass = TextField;
export { BryntumTextField as default };