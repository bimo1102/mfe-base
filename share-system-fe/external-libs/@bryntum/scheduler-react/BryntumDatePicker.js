...
import { DatePicker } from '@bryntum/scheduler/scheduler.umd';

var BryntumDatePicker = /*#__PURE__*/function (_Component) {
  _inherits(BryntumDatePicker, _Component);

  var _super = _createSuper(BryntumDatePicker);

  function BryntumDatePicker() {
    var _this;

    _classCallCheck(this, BryntumDatePicker);
    ...
    _this.configNames = ['activeDate', 'adopt', 'align', 'anchor', 'appendTo', 'bbar', 'bodyCls', 'bubbleEvents', 'cellRenderer', 'centered', 'cls', 'config', 'constrainTo', 'contentElementCls', 'dayNameFormat', 'defaultBindProperty', 'defaults', 'disabledDates', 'disableWeekends', 'dock', 'draggable', 'editMonth', 'editOnHover', 'floating', 'focusDisabledDates', 'footer', 'header', 'headerRenderer', 'hideAnimation', 'hideWhenEmpty', 'htmlCls', 'insertBefore', 'insertFirst', 'itemCls', 'lazyItems', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'maxDate', 'minColumnWidth', 'minDate', 'minRowHeight', 'monitorResize', 'month', 'multiSelect', 'namedItems', 'nonWorkingDays', 'owner', 'positioned', 'preventTooltipOnTouch', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'showWeekColumn', 'showWeekNumber', 'sixWeeks', 'strips', 'tab', 'tag', 'tbar', 'textAlign', 'textContent', 'tip', 'title', 'trapFocus', 'weekRenderer', 'weekStartDay', 'weight'];
  ...
  _createClass(BryntumDatePicker, [{
  ...
  return BryntumDatePicker;
}(Component);

BryntumDatePicker.instanceClass = DatePicker;
export { BryntumDatePicker as default };