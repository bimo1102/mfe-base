...
var BryntumButton = /*#__PURE__*/function (_Component) {
  ...
  function BryntumButton() {
    ...
    _this.configNames = ['adopt', 'align', 'anchor', 'appendTo', 'bubbleEvents', 'centered', 'cls', 'color', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'dock', 'draggable', 'floating', 'hideAnimation', 'href', 'htmlCls', 'insertBefore', 'insertFirst', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'menuIconCls', 'monitorResize', 'owner', 'positioned', 'preventTooltipOnTouch', 'ripple', 'rootElement', 'scrollAction', 'showAnimation', 'showTooltipWhenDisabled', 'tab', 'tag', 'target', 'textAlign', 'title', 'toggleable', 'toggleGroup', 'weight'];
