...
var BryntumToolbar = /*#__PURE__*/function (_Component) {
  _inherits(BryntumToolbar, _Component);

  var _super = _createSuper(BryntumToolbar);

  function BryntumToolbar() {
    var _this;

    _classCallCheck(this, BryntumToolbar);
...
export { BryntumToolbar as default };