...
import { ChipView } from '@bryntum/scheduler/scheduler.umd';

var BryntumChipView = /*#__PURE__*/function (_Component) {
  _inherits(BryntumChipView, _Component);

  var _super = _createSuper(BryntumChipView);

  function BryntumChipView() {
    var _this;

    _classCallCheck(this, BryntumChipView);
    ...
    _this.configNames = ['activateOnMouseover', 'adopt', 'align', 'allowGroupSelect', 'anchor', 'appendTo', 'bubbleEvents', 'centered', 'closable', 'closeHandler', 'cls', 'config', 'constrainTo', 'contentElementCls', 'defaultBindProperty', 'displayField', 'dock', 'draggable', 'floating', 'groupHeaderTpl', 'hideAnimation', 'htmlCls', 'iconTpl', 'insertBefore', 'insertFirst', 'itemTpl', 'listeners', 'localeClass', 'localizableProperties', 'maskDefaults', 'masked', 'monitorResize', 'multiSelect', 'owner', 'positioned', 'preventTooltipOnTouch', 'ripple', 'rootElement', 'scrollAction', 'selectAllItem', 'selected', 'showAnimation', 'showTooltipWhenDisabled', 'store', 'tab', 'tag', 'textAlign', 'title', 'toggleAllIfCtrlPressed', 'weight'];
  ...
  return BryntumChipView;
}(Component);

BryntumChipView.instanceClass = ChipView;
export { BryntumChipView as default };