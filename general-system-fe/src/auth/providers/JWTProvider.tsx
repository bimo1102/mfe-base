...
interface AuthContextProps {
    ...
    changePassword: (email: string, token: string, password: string, password_confirmation: string) => Promise<void>;
...
const AuthProvider = ({ children }: PropsWithChildren) => {
    ...
    const changePassword = async (email: string, token: string, password: string, password_confirmation: string) => {
