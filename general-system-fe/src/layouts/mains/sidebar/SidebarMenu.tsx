                ...
                <MenuItem
                    ...
                    <MenuLink
                        ...
                        <MenuIcon className={clsx('items-start text-gray-500 dark:text-gray-400', iconWidth)}>
                            {item.icon && <KeenIconsComponent name={item.icon} className={iconSize} type="" />}
                        </MenuIcon>
    ...
    const buildMenuArrow = () => {
        return (
            <MenuArrow className={clsx('text-gray-400 w-[20px] shrink-0 justify-end ms-1', rightOffset)}>
                <KeenIconsComponent name="plus" className="text-2xs menu-item-show:hidden" type="" />
                <KeenIconsComponent name="minus" className="text-2xs hidden menu-item-show:inline-flex" type="" />
            </MenuArrow>
        );
    };
